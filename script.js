...
let tagtwo =  document.querySelector('.two')


console.log("testing")

function Mover1(obj){
    obj.innerHTML = `<p style ="text-align : center ; padding :10px;">Working in a Ebs apps dba side , like upgradation , migration , backupand Build disaster recovery</p>`
}
function Mout1(obj){
